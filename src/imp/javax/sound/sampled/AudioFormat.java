 ...
 * @see AudioFileFormat
 * @see imp.javax.sound.sampled.spi.FormatConversionProvider
 * @since 1.3
 */
public class AudioFormat {
    ...
    public AudioFormat(float sampleRate, int sampleSizeInBits,
        ...
        this (
                (signed == true ? Encoding.PCM_SIGNED
    ...
    public boolean matches(AudioFormat format) {
        ...
        if (format.getEncoding().equals(getEncoding())
                && ((format.getSampleRate() == AudioSystem.NOT_SPECIFIED) || (format
                        .getSampleRate() == getSampleRate()))
                && (format.getSampleSizeInBits() == getSampleSizeInBits())
                && (format.getChannels() == getChannels()
                        && (format.getFrameSize() == getFrameSize())
                        && ((format.getFrameRate() == AudioSystem.NOT_SPECIFIED) || (format
                                .getFrameRate() == getFrameRate())) && ((format
	...
	public String toString() {
        ...
        String sSampleRate;
        if (getSampleRate() == AudioSystem.NOT_SPECIFIED) {
        ...
        if (Math.abs(getSampleRate() - getFrameRate()) > 0.00001) {
            if (getFrameRate() == AudioSystem.NOT_SPECIFIED) {
        ...
        String sEndian = "";
        if ((getEncoding().equals(Encoding.PCM_SIGNED) || getEncoding()
                .equals(Encoding.PCM_UNSIGNED))
    ...
    public static class Encoding {
         ...
         */
        public static final Encoding PCM_SIGNED = new Encoding(
                "PCM_SIGNED");
