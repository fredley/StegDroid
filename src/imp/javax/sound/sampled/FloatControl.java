/*
 ...
 public abstract class FloatControl extends Control {
     ...
     protected FloatControl(Type type, float minimum, float maximum,
             ...
             String units, String minLabel, String midLabel,
             String maxLabel) {
     ...
     public void setValue(float newValue) {
         ...
         if (newValue > maximum) {
             throw new IllegalArgumentException("Requested value "
                     + newValue + " exceeds allowable maximum value "
                     + maximum + ".");
         }
         ...
         if (newValue < minimum) {
             throw new IllegalArgumentException("Requested value "
                     + newValue
                     + " smaller than allowable minimum value "
                     + minimum + ".");
         }
	...
	public String toString() {
         return new String(getType() + " with current value: "
                 + getValue() + " " + units + " (range: " + minimum
                 + " - " + maximum + ")");
     }
     ...
     public static class Type extends Control.Type {
          ...
          * @see #REVERB_SEND
          */
         public static final Type REVERB_RETURN = new Type(
                 "Reverb Return");
